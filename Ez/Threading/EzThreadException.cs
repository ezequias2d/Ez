...
namespace Ez.Threading
{
    ...
    /// </summary>
    public class EzThreadException : EzException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzThreadException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzThreadException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzThreadException"/> class with serialized data.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzThreadException"/> class with a specified
