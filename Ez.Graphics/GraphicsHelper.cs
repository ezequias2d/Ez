...
namespace Ez.Graphics.Data
{
    ...
    public static class GraphicsHelper
    {
        ...
        internal static void Set<T>(ref T[] array, ref int length, ReadOnlySpan<T> value) where T : unmanaged
        {
        ...
        internal static void SetManaged<T>(ref T[] array, ref int length, ReadOnlySpan<T> value)
        {
