...
{
    public class GlfwJoystickState : IJoystickState, IDisposable
    {
        ...
        private void UpdateButtons()
        {
            ...
            if (buttons.Count > 0)
            {
                ...
                try
                {
                    ...
                    MemUtil.Copy<bool, JoystickInputAction>(Buttons, ((ReadOnlySpan<JoystickInputAction>)buttons).Slice(0, ButtonCount));
                }
                finally
                {
        ...
        private void UpdateAxes()
        {
            ...
            if (axes.Count > 0)
            {
                ...
                try
                {
                    ...
                    MemUtil.Copy(Axis, ((ReadOnlySpan<float>)axes).Slice(0, AxisCount));
                }
                finally
                {
        ...
        private void UpdateHats()
        {
            ...
            if (hats.Count > 0)
            {
                ...
                try
                {
                    ...
                    MemUtil.Copy<Hat, JoystickHats>(Hats, ((ReadOnlySpan<JoystickHats>)hats).Slice(0, HatCount));
                }
                finally
                {
