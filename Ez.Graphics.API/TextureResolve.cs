...
namespace Ez.Graphics.API
{
    ...
    public struct TextureResolve
    {
        ...
        /// </summary>
        public TextureSubresourceLayers SourceSubresource { get; set; }

        /// <summary>
        /// Gets or sets the initial x, y, and z offsets in texels of the sub-regions of the 
        /// source texture data.
        /// </summary>
        public Point3 SourceOffset { get; set; }

        /// <summary>
        /// Gets or sets the the source texture subresource for the texture data.
        /// </summary>
        public TextureSubresourceLayers DestinationSubresource { get; set; }
        ...
        /// texture data.
        /// </summary>
        public Point3 DestinationOffset { get; set; }
